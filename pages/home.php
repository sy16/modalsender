...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary mb-4" data-toggle="modal" data-target="#tambahNomorModal">Synchronize to server</button>
                    <div class="table table-responsive">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            <div class="d-inline-flex p-2"> Status Koneksi : </div>
                            <div class="d-inline-flex p-2 text-success"> Connected </div>
                        </div>

                        <div class="d-flex">
                            <div class="d-inline-flex p-2"> Status Data : </div>
                            <div class="d-inline-flex p-2 text-success"> Synchronized </div>
                        </div>
                    </div>
                </div>
            </div>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://web.facebook.com/mycodingxd">HambaAllah</a></span>
