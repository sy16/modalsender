...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2022 at 05:46 PM
...
(104, 'uba', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'e4d5377583b920c00efff5b50d2c1da1187683c1', '1', 60);
...
--
-- Table structure for table `izin_bidan`
--

CREATE TABLE `izin_bidan` (
  `id_bidan` int(11) NOT NULL,
  `sipb` text NOT NULL,
  `nama` text NOT NULL,
  `temp_lahir` text NOT NULL,
  `tg_lahir` date NOT NULL,
  `alamat` text NOT NULL,
  `no_strb` text NOT NULL,
  `uk_praktik` text NOT NULL,
  `al_praktik` text NOT NULL,
  `no_rekom` text NOT NULL,
  `tg_rekom` date NOT NULL,
  `terbit` date NOT NULL,
  `ms_berlaku` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `izin_bidan`
  MODIFY `id_bidan` int(11) NOT NULL AUTO_INCREMENT;
