...
<head>
    ...
    <title>Modal Sender Pro - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-success " id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
                ...
                <div class="sidebar-brand-text mx-3">Modal Sender</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="latihan/sendmessage2.php">
                    <i class="fas fa-envelope"></i>
                    Kirim pesan (Terjadwal) </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="latihan/ambil_detailpesan.php">
                    <i class="fas fa-envelope"></i>
                    Detail Pesan </a>
            </li>
